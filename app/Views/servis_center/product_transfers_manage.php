...
<form action="<?= base_url('warehouse/transfers/items')?>" method="post"> 
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url('warehouse/transfers/delete/'.$good_transfers->id.'/items/'.$value->id) ?>"onclick="return confirm('Yakin ingin menghapus <?= $value->product_name ?> dari daftar transfer barang.?')" class="btn btn-danger text-white btn-sm" title="delete Purchase">
