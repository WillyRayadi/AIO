...
<form action="<?= base_url('sales/transfers/insert_data_awal') ?>" method="post">
                        ...
                        ?>
                            ...
                            <tr>  
                                ...
                                <td class='text-center'> 
                                     ...
                                     <a href="<?= base_url('sales/transfers/manage') . '/' . $transfer->id ?>" title="Kelola" class="btn btn-success btn-sm text-white">
                                        <i class='fa fa-cog'></i>
                                    </a>
