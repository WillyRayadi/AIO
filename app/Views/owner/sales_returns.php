...
<li class="breadcrumb-item active">Sales Retur</li>
<?= $this->endSection() ?>

<?= $this->section("page_content") ?>

<!-- Modal Add -->
<form method="post" action="<?= base_url("owner/sales/return/add") ?>">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class='text-center'>
                                <a href="<?= base_url('owner/sales/return/manage') . '/' . $stok->id ?>" class="btn btn-success btn-sm"><i class="fas fa-cog"></i></a>
                                <a href="<?= base_url('owner/sales/sale/retur/delete') . '/' . $stok->id ?> " class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr> 
                        <?php endforeach ?>
                    </tbody> 
