...
<form action="<?= base_url('owner/sales/return/add/items')?>" method="post"> 
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-1">
                        ...
                        <label class="float-right" style="margin-right: 57px;">Jumlah Yang Ingin Diretur</label>
                        <div class='row'>
                            <div class="form-group">
                                <div class="col-md-12">
    ...
    <div class='col-md-4'>
        <div class='card'>
            <div class="card-header bg-info">
                ...
                <a href="<?= base_url('owner/sales/sale/retur/print/'.$good_retur->id) ?>" class="btn btn-sm btn-success float-right"><i class="fas fa-print"></i></a> 
            </div>
            <div class="card-body"> 
                <b>Nomer Returs</b>
                <br>
                    ...
                    <table class="table table-striped table-bordered table-hover"> 
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url('owner/sales/sale/retur/delete/'.$good_retur->id.'/items/'.$value->id) ?>" onclick="return confirm('Yakin ingin menghapus <?= $value->product_name ?> dari data retur.?')" class="btn btn-danger text-white btn-sm" title="delete Purchase">
