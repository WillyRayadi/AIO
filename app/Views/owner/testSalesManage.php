...
<li class="breadcrumb-item"><a href="<?= base_url('/sales/sales'); ?>">Penjualan Testing</a></li>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <form method="post" action="<?= base_url('sales/test/sales/save') ?>">
...
<script>
    ...
    function load_warehouse(id_product,warehouse_id){
        $.ajax({
            url: "<?= base_url('sales/ajax/test/sale/product/all') ?>",
            type: "post",
            data: {
                product     : id_product,
