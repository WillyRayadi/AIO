                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea class='form-control text-uppercase' placeholder="Memo / Catatan" name='sales_notes'><?= $sale->sales_notes ?></textarea>
                            </div>

                            <div class="form-group">
                                <label>Gudang</label>
                                <select name='warehouse' class='form-control select2bs4' required>
                                    <option value="">--Pilih Gudang--</option>
                                    <?php
                                    foreach ($branch as $item) {
                                        if ($item->id == $sale->warehouse_id) {
                                            $selected = "selected";
                                        } else {
                                            $selected = "";
                                        }
                                        echo "<option value='" . $item->id . "' $selected>" . $item->name_city . "</option>";
                                    }
                                    ?>
                                </select>
                            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <?php if ($sale->is_saved == 0 && $sale->contact_id != NULL && $isItemExist == true) : ?>
                        <a href="<?= base_url("sales/so/$sale->id/save") ?>" class="btn btn-primary float-right">Simpan Penjualan</a>
                    <?php endif; ?>
                </div>
            </div>
    ...
    $("#productSelect").change(function() {
        $.ajax({
            ...
            success: function(html) {
                ...
                // if (empty($(this).val())) {
                //     $("#totalStock").val("Pilih Barang Terlebih Dahulu");
                // } else {
                //     $("#totalStock").val(stocks + " " + myText[1]);
                // }
                // if(stocks == 0) {}
        ...
        load_warehouse($(this).val(), <?= $sale->warehouse_id ?>);
