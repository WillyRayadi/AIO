...
<li class="breadcrumb-item active">Report Persetujuan</li>
...
<div class="card">
    <div class="card-header bg-info">
        <h5 class="card-title">Report Data Persetujuan</h5>
    </div>
    <div class="card-body">
        <div class="container align-items-center">
            <form action="<?= base_url('sales/export_activity_approval') ?>" method="get" target="_blank">
                <div class="row">
