...
Persediaan Berdasarkan Gudang
<?= $this->endSection() ?>

<?= $this->section("page_breadcrumb") ?>
<li class="breadcrumb-item"><a href="<?= base_url('/dashboard'); ?>">Home</a></li>
<li class="breadcrumb-item active">Persediaan Berdasarkan Gudang</li>
<?= $this->endSection() ?>
                ...
                <table class="table table-bordered table-striped" id='datatables-default'>
                    <thead>
                        <tr>
                            ...
                            <th class='text-center'rowspan='2'>Persediaan Tersedia</th>
                        </tr>
                        <tr>
                            <?php
                            ...
                            <tr>
                                ...
                                <td class='text-right'>
                                    ...
                                    if($location->quantity == NULL){
                                        ...
                                        $thisSumStocks += $location->quantity;
                                ...
                                ?>                                
                                <td class='text-right'><?= $thisSumStocks." ".$product->unit; ?></td>                                
                            </tr>
                            <?php
                        }
                        ?>
