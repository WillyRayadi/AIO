...
<form action="<?= base_url('products/transfers/insert_data_awal') ?>" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class='mb-2'>
                                ...
                                <select name='to_warehouse' class='form-control' id="warehouseSelect" required>
                                    <option value="">-- Pilih Gudang --</option>
                    ...
                    <table class="table table-bordered table-striped" id="datatables-default">
                        ...
                        ?>
                            ...
                            <tr>  
                                ...
                                <td>
                                    <?php
                                        if(!empty($fromWarehouse->name)) {
                                            echo $fromWarehouse->name;
                                        }else{
                                            echo "-";
                                        }
                                    ?>
                                ...
                                <td>
                                <?php
                                 if(!empty($toWarehouse->name)) {
                                     echo  $toWarehouse->name;
                                 }else{
                                     echo "-";
                                 }
                                ?>
                                ...
                                <td class='text-center'> 
                                    ...
                                    <a href="<?= base_url('products/transfers/manage') . '/' . $transfer->id ?>" title="Kelola" class="btn btn-success btn-sm text-white">
                                        <i class='fa fa-cog'></i>
                                    </a>
                                    <?php endif ?>
                                    ...
                                    if($roles->transfer_warehouse_hapus != NULL ): ?>
                                        ...
                                        ?>
                                        <a href="<?= base_url('products/transfers/'.$transfer->id.'/delete') ?>" class='btn btn-danger btn-sm' onclick="return confirm('Yakin hapus.?')" title="Hapus"> 
