...
Pengelolaan Subkategori Barang
<?= $this->endSection() ?>

<?= $this->section("page_breadcrumb") ?>
<li class="breadcrumb-item"><a href="<?= base_url('/dashboard'); ?>">Home</a></li>
<li class="breadcrumb-item active">Pengelolaan Subkategori Barang</li>
<?= $this->endSection() ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-green">
                    <h5 class="modal-title" id="staticBackdropLabel">Edit Subkategori Barang</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="editNameproducts_category">Nama Subcategori</label>
...
<div class="container-fluid mt-4">
    <div class="row">
        <div class="col-4">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Tambah Subategori Barang</h3>
                </div>
                <div class="card-body">
                    <form method="post" action="<?= base_url("add/subkategori"); ?>">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="subcategori" placeholder="Nama" required>
                        </div>
                        <div class="form-group">
                            <label>Kode</label>
                            <select name='codes' class='select2bs4 form-control'>
                                <?php
        ...
        <div class="col-8">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Data Subkategori Barang</h3>
                </div>
                <div class="card-body table-responsive">
                    <table class="table table-bordered table-striped dataTable dtr-inline" id="datatables-default">
                        ...
                        <tbody>
                            <?php
                            $d = 0;
                            foreach ($subcategori as $products_category) {
                                $d++;
                            ?>
                                <tr>
                                    ...
                                    <td class='text-center'>
                                        ...
                                        ?>
                                            ...
                                            <a href="<?= base_url('products/categories') . '/' . $products_category->id . '/delete' ?>" title="Hapus" onclick="return confirm('Yakin hapus subkategori Barang : <?= $products_category->name ?> ?')" class='btn btn-sm btn-danger text-white'>
