...
<div class="row">
    <div class="col-md-6">
        <div class="card">
                ...
                if ($this->session->login_id == 14): ?>
                    <div class="card-body">
                        Selamat Datang <b><?= config("Login")->loginName ?></b>, sebagai <?= config("App")->roles[config("Login")->loginRole] ?>, Semangat Kerjanya yaa
                    </div>
                <?php else: ?>
                    <div class="card-body">
...
<div class="card">
    ...
    <div class="card-body">
        <table class="table table-striped table-bordered" id="datatables-secondary">
            <thead>
                <tr>
