                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="cabangIDD"  name="cabang_id" value="<?= $sale->cabang_id ?>"  class="form-control" placeholder="Lokasi Cabang Toko">
                            </div>
                        </div> 
                    </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select name='warehouse' class='form-control' id="warehouse">
                                    <option value="1">Gudang Ladafa</option>
                                    <option value="2">Toko AIO</option>
                                    <option value="3">Toko ASS</option>
                                </select>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class='text-right'>
                                       ...
                                       <?php
                                        $bundlings = $db->table('sale_item_bundlings');
                                        $bundlings->select([
                                            'sale_item_bundlings.id',
                                            'sale_item_bundlings.price',
                                            'sale_item_bundlings.promo_id',
                                            'sale_item_bundlings.quantity',
                                            'products.name as product_name',
                                            'sale_item_bundlings.product_id',
                                            'sale_item_bundlings.price_level',
                                            'sale_item_bundlings.sale_item_id',
                                            'sale_item_bundlings.product_stock_id',
                                        ]);

                                        $bundlings->join('promos', 'sale_item_bundlings.promo_id = promos.id','left');
                                        $bundlings->join('products','sale_item_bundlings.product_id = products.id','left');
                                        $bundlings->where('sale_item_bundlings.sale_item_id',$item->id);
                                        $bundlings->orderBy('sale_item_bundlings.id','asc');
                                        ...
                                        if($bundlings != NULL){
                                            echo "<hr>";
                                            echo "<span>".'Rp.'.number_format($bundlings->price,0,",",".")."</span>";
                                        }
                                    ...
                                    <hr>
                                        ...
                                        if($bundlings != NULL){
                                            $thisPriceCount = $bundlings->price * $bundlings->quantity;
    
                                            echo "Rp. ".number_format($thisPriceCount,0,",",".");
                                            $sumPrice += $thisPriceCount;
                                        }
...
<!-- <script type="text/javascript">
    document.getElementById("cabangIDD").value = "Cirebon - Kalijaga";
</script> -->
<?= $this->endSection() ?>