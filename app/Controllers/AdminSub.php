...
class AdminSub extends BaseController
{
    ...
    private function getSalesAge()
    {
        ...
        $transfers = $this->productStockModel
            ...
            // ->join("warehouse_transfers", "product_stocks.warehouse_transfer_id = warehouse_transfers.id", "left")
            // ->join("warehouse_transfers_items", "warehouse_transfers.id = warehouse_transfers_items.warehouse_transfers_id", "left")
