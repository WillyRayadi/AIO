...
class Sales extends BaseController
{
    ...
    protected $bundlingModel;
    protected $saleItemBundlingModel;
    protected $warehouseTransferModel;
    protected $warehouseTransfersItemsModel;
    ...
    public function ajax_sale_product_prices()
    {
        ...
        if (config("Login")->loginRole == 7) {
            ...
            if ($product->price_cg != 0) {
                echo "<option value='15-" . $product->price_cg . "'>Rp. " . number_format($product->price_cg, 0, ",", ".") . " (HYD Retail)</option>";
            }
        }
