...
<div class="col-md-12">
        <div class="card">
            <div class="card-header bg-info">
                <h5 class="card-title">Penjualan Dengan Status Dikirim</h5>
            </div>
                    ...
                    <tbody>
                        ...
                        foreach($sales as $sale){
                            ...
                            <tr>
                                ...
                                <td class='text-center'>
                                    <a href="<?= base_url('sales/delivery/'.$sale->id.'/manage') ?>" class='btn btn-success btn-sm' title="Kelola Pesanan Penjualan">
                                        <i class='fa fa-cog'></i>
                                    </a>
                                </td>
                            </tr>
