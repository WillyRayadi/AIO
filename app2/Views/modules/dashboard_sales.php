...
$approve->where('admin_id', $session->login_id);
...
$delivery->where('admin_id', $session->login_id);
...
$deliveries->where('admin_id', $session->login_id);
...
$end->where('admin_id', $session->login_id);
