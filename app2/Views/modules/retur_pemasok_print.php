...
<body>
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody> 
            ...
            ?>
            <tr>
                <td class="text-center"><?= $retur->product_name ?></td>
                <td class='text-center'><?= $retur->quantity?> unit</td>                
            </tr>
            <?php endforeach ?>
      </tbody>
    </table>
