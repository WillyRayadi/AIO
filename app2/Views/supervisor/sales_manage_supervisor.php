...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <form method="post" action="<?= base_url('supervisor/sales/save') ?>">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="member_id" class="form-control">
                                    <?php foreach ($team as $key => $value): ?>
                                        <option value="<?= $value->team_member_id ?>"><?= $value->name ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="cabang_id" class="form-control" value="<?= $sale->cabang_id ?>" placeholder="Lokasi Cabang Toko">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">   
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="order_id" value="<?= $sale->order_id ?>"></input>
                            </div>         
                ...
                <div class="card-footer">
                    ...
                    <a href="<?= base_url('supervisor/penjualan/'.$sale->id.'/delete') ?>" onclick="return confirm('Yakin hapus penjualan (SO).?')" class='btn btn-danger float-right ml-2'>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="<?= base_url('supervisor/sale/item/add') ?>">
                    <input type='hidden' name='warehouse' value="<?= $sale->warehouse_id ?>">
                    <input type='hidden' name='sale' value="<?= $sale->id ?>">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <tbody>
                            ...
                            foreach($items as $item){
                                ...
                                <tr>
                                    ...
                                    <td class='text-center'>                                  
                                        <a href="<?= base_url('supervisor/sales/'.$sale->id.'/item/'.$item->id.'/delete') ?>" class='btn btn-danger btn-sm' onclick="return confirm('Yakin hapus <?= $itemNameForEditQty ?> dari daftar penjualan.?')" title="Hapus">
                                            <i class='fa fa-trash'></i>
                                        </a>
                                    </td>
                                </tr>
...
$("#contactSelect").change(function(){
    ...
    $.ajax({
        url : "<?= base_url('supervisor/ajax/sales/add/contact/data') ?>",
        data : { id : id },
        type : "POST",
...
$("#paymentSelect").change(function(){
    ...
    $.ajax({
        url : "<?= base_url('supervisor/ajax/sales/add/expired/data') ?>",
        data : { id : id },
        type : "POST",
        success : function(response){
...
<script>
    ...
    $("#productSelect").change(function(){
        $.ajax({
            url: "<?= base_url('supervisor/ajax/sale/product/stocks') ?>",
            type: "post",
            data: {
                product     : $(this).val(),
            }, 
        ...
        $.ajax({
            url: "<?= base_url('supervisor/ajax/sale/product/prices') ?>",
            type: "post",
            data: {
                product     : $(this).val(),
            },
        ...
        $.ajax({
            url: "<?= base_url('supervisor/ajax/sale/product/promos') ?>",
            type: "post",
            data: {
    ...
    function load_warehouse(id_product,warehouse_id){
        $.ajax({
            url: "<?= base_url('supervisor/ajax/sale/product/all') ?>",
            type: "post",
            data: {
                product     : id_product,
