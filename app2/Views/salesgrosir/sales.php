...
<div class="row">
    <div class="col-md-12">
        <a href="<?= base_url('sales/grosir/sales/add') ?>" class='btn btn-primary float-right'>
                    ...
                    <tbody>
                        ...
                        foreach($sales as $sale){
                            ...
                            <tr>
                                ...
                                <td class='text-center'>
                                    <a href="<?= base_url('sales/grosir/sales/'.$sale->id.'/manage') ?>" class='btn btn-success btn-sm' title="Kelola Pesanan Penjualan">
                                        <i class='fa fa-cog'></i>
                                    </a>
                                </td>
                            </tr>
