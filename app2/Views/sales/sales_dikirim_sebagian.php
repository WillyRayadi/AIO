...
<div class="col-md-12">
        <div class="card">
            <div class="card-header bg-info">
                <h5 class="card-title">Penjualan Dengan Status Dikirim Sebagian</h5>
            </div>
                ...
                <table class="table table-striped table-bordered" id="datatables-default">
                    ...
                    <tbody>
                        ...
                        foreach($sales as $sale){
                            ?>
                            <tr>
                                <td class='text-center'><a href="<?= base_url('warehouses/sales/'.$sale->id.'/manage')?>"><?= $sale->sale_number ?></a></td>
