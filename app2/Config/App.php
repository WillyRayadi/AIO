...
{
    public $name = "Aplikasi Stok Barang";
    public $companyName = "AIO Store";
    public $ptName = "PT. Global Mitratama Cemerlang";
    public $companyAddress = "Jl. Kalijaga Jl. Kesunean No.4, Pegambiran, Kec. Lemahwungkuk, Kota Cirebon, Jawa Barat 45114";
    public $companyPhone = "(0231) 225795";
    public $yearMade = 2024;
    /**
     * --------------------------------------------------------------------------
     * Base Site URL
     * --------------------------------------------------------------------------
    ...
    public $roles = ([
        ...
        "Supervisor Grosir", "Gudang", "Owner", "Audit", "Cashier", "Service Center", "Partner"
    ]);
     ...
     * @var string
     */
    public $sessionSavePath = WRITEPATH . '/writable/session';
